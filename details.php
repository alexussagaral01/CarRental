            ...
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:block">
                    <ul class="flex space-x-1">
                        ...
                        <li>
                            <a href="details.php" class="px-4 py-2 rounded-lg text-gray-700 bg-gray-100 text-blue-600 font-medium transition-all duration-200 flex items-center space-x-1">
