...
<head>
    ...
    <title>RentWheels - Contact Us</title>
...
<body class="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
    ...
    <div class="container mx-auto px-4 py-12">
        <div class="text-center mb-12">
            <h1 class="text-4xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Contact Us</h1>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <textarea id="message" name="message" rows="4" required
                                class="w-full px-4 py-2 rounded-lg border border-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"></textarea>
                        </div>
                        <button type="submit"
                            class="w-full bg-gradient-to-r from-blue-600 to-indigo-600 text-white px-6 py-3 rounded-lg hover:opacity-90 transition duration-300">
                            Send Message
                        </button>
                    </div>
                </form>
                    ...
                    <div class="space-y-4">
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">123 Rental Street, City, Country</p>
                            </div>
                        </div>
                        <div class="flex items-start">
                            <div class="bg-gradient-to-r from-blue-600 to-indigo-600 p-3 rounded-lg">
                        ...
                        <div class="flex items-start">
                            ...
                            <div class="ml-4">
                                ...
                                <p class="text-gray-600">info@rentwheels.com</p>
                            </div>
                        </div>
                    </div>
                </div>
