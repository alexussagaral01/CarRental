...
<body class="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
    ...
    <div class="container mx-auto px-4 py-6 max-w-5xl">
        ...
        <div class="glass-effect rounded-2xl shadow-2xl p-6 md:p-8">
            ...
            <!-- Action Buttons -->
            <div class="relative flex justify-between items-center mt-8 pt-6 border-t">
                <!-- Left button -->
                <div class="flex space-x-4">
                    <button onclick="window.location.href='vehicles.php'" class="px-6 py-3 bg-gradient-to-r from-gray-700 to-gray-900 text-white rounded-lg hover:opacity-90 transition-all duration-200 no-print">
                        Book Again
                    </button>
                </div>
