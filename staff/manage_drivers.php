...
<body class="min-h-screen bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
            ...
            <div class="flex items-center justify-between h-20">
                ...
                <nav class="hidden md:block">
                    <ul class="flex space-x-1">
                        ...
                        <li>
                            <a href="manage_vehicle" class="px-4 py-2 rounded-lg text-gray-700 hover:bg-gray-100 hover:text-blue-600 font-medium transition-all duration-200 flex items-center space-x-1">
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <!-- Add Driver Button -->
        <button class="mb-6 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2">
        ...
        <div class="bg-white rounded-lg shadow-md overflow-hidden">
            <!-- Table Header -->
            <div class="grid grid-cols-6 gap-4 p-4 bg-gray-50 border-b border-gray-200">
                ...
                <div class="font-semibold text-gray-600">Rating</div>
            ...
            <div class="divide-y divide-gray-200">
                <!-- Driver 1 -->
                <div class="grid grid-cols-6 gap-4 p-4 items-center hover:bg-gray-50">
                    <div class="flex items-center space-x-3">
                        <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name=John+Doe" alt="Driver photo">
                        <span class="font-medium">John Doe</span>
                    </div>
                    <div>LIC-123456</div>
                    <div>+1 234-567-8900</div>
                    <div><span class="px-2 py-1 rounded-full text-sm bg-green-100 text-green-800">Available</span></div>
                ...
                <div class="grid grid-cols-6 gap-4 p-4 items-center hover:bg-gray-50">
                    <div class="flex items-center space-x-3">
                        <img class="h-10 w-10 rounded-full" src="https://ui-avatars.com/api/?name=Jane+Smith" alt="Driver photo">
                        <span class="font-medium">Jane Smith</span>
                    </div>
                    <div>LIC-789012</div>
                    <div>+1 234-567-8901</div>
                    <div><span class="px-2 py-1 rounded-full text-sm bg-red-100 text-red-800">On Duty</span></div>
                    <div class="flex items-center">
                        <span class="text-yellow-500">★★★★★</span>
